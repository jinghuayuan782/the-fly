...
void wifiInit(void)
{
    ...
    esp_netif_ip_info_t ip_info = {
        .ip.addr = ipaddr_addr("192.168.43.1"),
        .netmask.addr = ipaddr_addr("255.255.255.0"),
        .gw.addr      = ipaddr_addr("192.168.43.1"),
    };
    ...
    dhcps_lease_t dhcps_lease = {
        .enable = true,
        .start_ip.addr = ipaddr_addr("192.168.43.100"),
        .end_ip.addr = ipaddr_addr("192.168.43.150"),
    };
    ESP_ERROR_CHECK(esp_netif_dhcps_option(ap_netif, ESP_NETIF_OP_SET, ESP_NETIF_REQUESTED_IP_ADDRESS, &dhcps_lease, sizeof(dhcps_lease)));
